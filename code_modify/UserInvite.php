...
class UserInvite extends Controller
{
    ...
    public function post(array $params): Response
    {
        ...
        if (isset($_POST["complete"]) && isset($_POST["step"]) && $_POST["step"] == 5) {
            ...
            // 删除步骤234后，设置默认值
            $this->settingService->saveSetting("usersettings." . $userInvite['id'] . ".challenge", "organization");
            $this->settingService->saveSetting("usersettings." . $userInvite['id'] . ".impact", "accomplish");
            $this->settingService->saveSetting("usersettings." . $userInvite['id'] . ".function", "focused");
